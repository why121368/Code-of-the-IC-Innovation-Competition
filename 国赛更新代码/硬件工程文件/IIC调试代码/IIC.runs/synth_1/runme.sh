...
HD_PWD='D:/MyWork/test/IIC/IIC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_control.tcl
